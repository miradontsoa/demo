...
var ulongitude = 10.9;
var uzoom = 8;
if($('.site-config').attr('data-location-latitude') && ($('.site-config').attr('data-location-latitude') != '')){
    ulatitude = $('.site-config').attr('data-location-latitude') ;    
}
if($('.site-config').attr('data-location-longitude') && ($('.site-config').attr('data-location-longitude') != '')){
    ulongitude = $('.site-config').attr('data-location-longitude') ;    
}
if($('.site-config').attr('data-location-zoom') && ($('.site-config').attr('data-location-zoom') != '')){
    uzoom = $('.site-config').attr('data-location-zoom') ;    
}
...
/* END OF Init News feed / Newsfeed */
