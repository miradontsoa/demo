...
(function ($) {
    ...
    $.fn.initForm = function( options ){
		var settings = $.extend({
			...
			//successInvisibleCallback : $('.subscription .title, .send_email_form button, .send_email_form input, .invite'),
						...
						success: function (data) {
							...
							// Else the login credentials were invalid.
							   ...
							   //Ajax connexion reject an error a success, now handle response
								...
								settings.textFeedback.html('We will process your request.');
