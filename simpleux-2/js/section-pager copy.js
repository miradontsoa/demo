...
; (function () {
    ...
    function _init() {
        ...
        // sectionPager.horizScrolWrap = sectionPager.container.querySelector('.scroll-slides');
        // sectionPager.slides = sectionPager.horizScrolWrap.querySelectorAll('.scroll-slide');
        // sectionPager.sticky = sectionPager.container.querySelector('.scroll-wrapper');
        ...
        sectionPager.sections.forEach(function (section, index) {
            ...
            //  // use data-section as attribute
            // if (section.getAttribute('data-section')) {
            //     dotNavLink.setAttribute('href', `#${section.getAttribute('data-section')}`)
